IT = [
  ...
  {
    "name": "format",
    "trans": ["n. 设计,版式 n.[计算机]格式,DOS命令 : 格式化(磁盘),用于空盘或使用过的磁盘建立新空盘来存储数据 v. vt.使格式化,设计,安排"]
  },
  ...
  {
    "name": "shell",
    "trans": ["n. 贝壳,壳,外形 vt. &vi. 去壳,脱落,炮击,拾贝壳 n.[计算机] DOS命令 : 安装备用的COMMAND.COM文件, 并改变环境尺寸"]
  },
  ...
  { "name": "selected", "trans": ["adj. 选定的 动词select的过去式和过去分词"] },
  ...
  {
    "name": "left",
    "trans": ["adj.左边的，左侧的； 左派的 n.左，左面； [军]左翼； 左派，激进分子 adv.向左； 在左边 v.离开( leave的过去式和过去分词)"]
  },
  ...
  { "name": "data", "trans": ["n. (datum的复数)资料,数据"] },
  { "name": "setting", "trans": ["n.镶嵌； 环境； 装置； （某事、戏剧、小说等的）背景 v.放( set的现在分词)； 安插； 树立； 安排"] },
  { "name": "desire", "trans": ["n. 愿望, 欲望, 情欲 v. 向往, 要求, 请求 vt. 渴望"] },
  { "name": "position", "trans": ["n. 位置, 职位; 状态, 立场 vt. 安置, 决定...的位置"] },
  { "name": "down", "trans": ["adj. 向下的,降低的,情绪低落,停止运行 adv. 向下的,下跌,在南方 n. 绒毛,汗毛,轻视 prep. 沿着...而下"] },
  ...
  { "name": "date", "trans": ["n. 日期,约会,枣椰子 vt. 约会,定日期 vi. 追溯到 n.[计算机] DOS命令 : 显示或设置系统日期"] },
  ...
  { "name": "beginning", "trans": ["n. 开始,开端，起源，早期 adj. 刚开始的 动词begin的现在分词"] },
  ...
  { "name": "rename", "trans": ["v. 重新命名, 改名 n. [计算机]DOS命令"] },
  ...
  { "name": "except", "trans": ["vt. 除,除外 prep.&conj. 除了...之外,若不是,除非"] },
  {
    "name": "turn",
  ...
  { "name": "install", "trans": ["v. 安装,安置,使...就职 n.[计算机] 安装,DOS命令 : 装入结束且驻留软件"] },
  ...
  {
    "name": "sort",
    "trans": ["n. 种类,样子,态度 v. 分类,整理,排序 n.[计算机] DOS命令 : 在字符型文件中进行数据排序, 或者将DOS命令的输出进行排序"]
  },
  ...
  { "name": "making", "trans": ["n. 制成 动词make的现在分词"] },
  ...
  { "name": "under", "trans": ["prep. 在...下,在...内,在...控制下,低于 adv. 在...下,在昏迷中,淹没地 adj. 下面的,从属的,少于的"] },
  ...
  { "name": "found", "trans": ["vt. 创立，建立；创办 v. 找到（find的过去分词）"] },
  ...
  { "name": "matching", "trans": ["adj. 匹配的, 相称的 动词match的现在分词"] },
  ...
  {
    "name": "times",
    "trans": ["n. 时间,期限,次数,乘 vt. 为...安排时间,计时,定时,乘 [计算机] DOS命令 : 显示并允许改变系统时间 adj. 根据时间的, 时间上的"]
  },
  ...
  { "name": "linux", "trans": ["一种可免费使用的类UNIX操作系统"] },
  ...
  { "name": "floating", "trans": ["adj.浮动的，流动性的，不固定的 动词float的现在分词形式"] },
  ...
  { "name": "separate", "trans": ["n. 分开, 抽印本 adj. 分开的, 各自的, 单独的 v. 分开, 隔开, 分居"] },
  {
    "name": "echo",
    "trans": [
      "n. 回声,回音,回波,反响,共鸣 vt. 发回声,回响, 重复, 仿效 vi. 回响, 回荡 n.[计算机] DOS命令 :禁止(或允许)批处理命令行显示屏幕上"
    ]
  },
  { "name": "necessary", "trans": ["adj. 必需的,必要的,必然的 n. [pl.]必需品"] },
  { "name": "able", "trans": ["adj. 能干的, 有能力的"] },
  { "name": "marking", "trans": ["n. 印记, 作记号，打分  动词mark的现在分词"] },
  ...
  { "name": "searching", "trans": ["adj. 探寻的，洞察的 动词search的现在分词"] },
  ...
  { "name": "separated", "trans": ["adj. 分开的 动词separate的过去式和过去分词"] },
  ...
  { "name": "learning", "trans": ["n. 学问, 学识, 学习 动词learn的现在分词"] },
  ...
  { "name": "blinking", "trans": ["adj. 闪烁的 adj. 该死的, 讨厌的, 十足的 动词blink的现在分词"] },
  ...
  { "name": "produce", "trans": ["n. 产品, 农作物 vt. 生产, 提出, 引起, 分娩, 制片 vi. 生产, 制造"] },
  {
    "name": "ram",
    "trans": [
      "abbr. 随机存取存储器（random access memory的缩写）；随机访问内存（random-access memory的缩写） n. 公羊；撞锤；撞击装置；有撞角的军舰；（水压机的）[机] 活塞 v. 撞击；填塞；强迫通过或接受"
    ]
  },
  ...
  { "name": "assumed", "trans": ["adj.假定的, 假装的  动词assume的过去式和过去分词"] },
  ...
  { "name": "trailing", "trans": ["adj. 牵引的 n. 拖尾 动词trail的现在分词形式"] },
  { "name": "seek", "trans": ["n. 找寻 v. 寻求,寻找,搜索"] },
  { "name": "introduction", "trans": ["n. 介绍, 引进, 导论, 序言"] },
  { "name": "indent", "trans": ["n. 契约, 订货单 v. 切割成锯齿状, 缩排, 定货 [计算机] 缩排, 缩进"] },
  { "name": "base", "trans": ["n. 基底,（支持、收入、力量等的）基础 vt. 以...作基础 adj. 卑鄙的；不道德的"] },
  { "name": "integer", "trans": ["n. 完整的事物,整体,整数 [计算机] 整数"] },
  { "name": "attempt", "trans": ["vt.试图； 尝试 n.进攻； 尝试，冲击"] },
  { "name": "twice", "trans": ["adv. 两倍, 两次"] },
  { "name": "formed", "trans": ["adj. 成形的 动词form的过去式和过去分词"] },
  { "name": "subscript", "trans": ["n. 下标 adj. 写在下方的"] },
  { "name": "tiny", "trans": ["adj. 极小的,微小的"] },
  { "name": "model", "trans": ["n. 模型, 模范, 模特儿 adj. 模范的, 作模型用的 v. 做模型, 塑造, 模仿"] },
  ...
  { "name": "sun", "trans": ["n. 太阳,阳光,中心人物,像太阳般的东西 vt.& vi. 晒太阳"] },
  { "name": "translate", "trans": ["vt. 翻译；转化；解释；转变为；调动 vi. 翻译"] },
  { "name": "reason", "trans": ["n. 理由,原因,理智,理性 vt. 说服,总结 vi. 规劝,下判断"] },
  { "name": "colon", "trans": ["n. 冒号, 结肠, 科朗(哥斯达黎加和萨尔瓦多的货币单位) (Colon)科隆(巴拿马港市)"] },
  ...
  { "name": "verify", "trans": ["v. 查证,核实 n.[计算机] DOS命令 : 打开关闭在 DOS操作期间的写文件校验开关"] },
  ...
  { "name": "sum", "trans": ["n. 总数(计),金额,顶点,概略,一笔钱 vt. 总计,概括 vi. 总计"] },
  { "name": "achieve", "trans": ["vt. 完成,达到,实现 vi. 达到目的"] },
  { "name": "together", "trans": ["adv. 一起，共同，相结合，同时地，协调地 adj. 头脑清楚的，镇定的"] },
  { "name": "affect", "trans": ["vt. 影响, 作用, 感动"] },
  { "name": "delay", "trans": ["n. 耽搁,迟滞 vt. 耽搁,延迟 vi. 耽搁"] },
  { "name": "free", "trans": ["adj. 自由的,大方的,免费的 vt. 释放,解放 adv. 自由地,免费地"] },
  ...
  { "name": "invalid", "trans": ["adj. 无效的,伤残的 n. 病人,残疾者 vt. 失去健康"] },
  { "name": "compiler", "trans": ["n. 编辑者，[计算机]编译器, 编译程序"] },
  { "name": "dot", "trans": ["n. 小圆点,少量,小东西 vt. 作小点记号,点缀 vi. 作小点记号 [计算机] 点"] },
  { "name": "beep", "trans": ["n. 哔哔声 vt. 产生（如号角）声音 vi. 吹号，发出哔哔声"] },
  { "name": "face", "trans": ["n. 脸, 神情, 面子, 表面 vt. 面对, 朝 vi. 朝, 向"] },
  { "name": "random", "trans": ["n. 随意,任意 adj. 任意的,随便的,胡乱的 adv. 随机地"] },
  { "name": "facility", "trans": ["n.设备； 容易； 能力； 灵巧"] },
  { "name": "heading", "trans": ["n. 标题，题目，航向 动词head的现在分词"] },
  ...
  { "name": "welcome", "trans": ["vt.欢迎； 乐于接受 adj.受欢迎的； 令人愉悦的； 表示感谢的 n.欢迎，迎接"] },
  ...
  { "name": "blue", "trans": ["adj. 蓝色的,沮丧的,忧郁的,(女人)有学问的 n. 蓝色 vt. 使...变蓝 vi. 变蓝"] },
  { "name": "queue", "trans": ["n. 行列,长队 v. 排队 vi. 排长队"] },
  { "name": "interrupt", "trans": ["n. 中断 vt. 打断,妨碍 vi. 插嘴 [计算机] 中断"] },
  { "name": "respect", "trans": ["n. 尊敬, 敬重; 关系, 方面 vt. 尊敬, 尊重; 关于, 涉及"] },
  { "name": "common", "trans": ["adj. 共同的, 平常的, 普通的 n. 平民, 普通, 公地, 公园"] },
  ...
  { "name": "certain", "trans": ["adj. 一定的 pron. 某几个,某些  肯定的,无疑的,必然发生的"] },
  { "name": "zap", "trans": ["vt. 击溃，射杀 vi. 快速移动 int. 嚓(表示枪声等）"] },
  { "name": "archive", "trans": ["n. 档案,档案馆 vt. 存档"] },
  { "name": "negative", "trans": ["adj. 否定的,负的,消极的 n. 底片，负数，否定 vt. 否定"] },
  { "name": "image", "trans": ["n. 图像,影像,肖像,想像,形象 vt. 想像,描绘,反映"] },
  { "name": "platform", "trans": ["n. 平台,月台,讲台,坛,计划"] },
  { "name": "often", "trans": ["adv. 经常"] },
  { "name": "signal", "trans": ["n. 信号,导火线,动机 vt. 发信号,标志 vi. 发信号 adj. 显著的"] },
  { "name": "CPU", "trans": ["abbr. [计算机]中央处理器(=central processing unit)"] },
  { "name": "bit", "trans": ["n. 一点儿,少量 n. 钻头,马嚼子,辅币 n. 位,比特(二进位制信息单位) v. 控制"] },
  ...
  { "name": "recommend", "trans": ["vt. 建议, 推荐, 劝告 vt. 使成为可取, 使受欢迎"] },
  { "name": "maintain", "trans": ["vt. 维持; 维修, 保养; 坚持; 断言"] },
  { "name": "important", "trans": ["adj. 重要的,影响很大的"] },
  { "name": "central", "trans": ["adj. 中心的,基本的,折中的,中枢的 n. 电话交流,中央办公室,中心"] },
  { "name": "addition", "trans": ["n. 增加,附加物,加,加法"] },
  { "name": "anytime", "trans": ["adv. 任何时候；无例外地"] },
  { "name": "analyst", "trans": ["n. 分析家"] },
  { "name": "false", "trans": ["adj. 不真实的,错误的,人造的,假的,虚伪的 adv. 不真诚地,虚伪地"] },
  { "name": "black", "trans": ["adj.黑（色）的； 黑色人种的； 黑暗的 n.黑色； 黑人； 黑颜料； 黑暗 v.使变黑； 抵制； 拒绝； 使变黑暗"] },
  { "name": "gather", "trans": ["vt.收集； 聚集，搜集； 收紧，收缩； 采集 vi.逐渐增加，积聚 n.聚集； 衣褶"] },
  { "name": "cycle", "trans": ["n. 循环,周期,长期,圈,套曲,自行车, vt. 环行,骑自行车 vi. 使环行"] },
  { "name": "relative", "trans": ["adj. 相对的,比较的,涉及到的 n. 亲属,同类事物,相关物"] },
  { "name": "offer", "trans": ["n. 出价, 提议 vt. 提供, 出价; 贡献, 奉献 vi. 提议; 出现; 求婚"] },
  { "name": "ending", "trans": ["n. 结尾, 结局"] },
  { "name": "rent", "trans": ["n. 租金 v. 租 vi. 出租 vt. 出租,租用"] },
  { "name": "sentence", "trans": ["n. 句子,意见,宣判,刑罚,命题 vt. 宣判,判决,使遭受"] },
  ...
  { "name": "examine", "trans": ["vt.检查，调查； 考试； 诊察； 审问 vi.检查； 调查"] },
  { "name": "initial", "trans": ["n. (词)首字母 adj. 开始的, 最初的, 字首的 vt. 签姓名的首字母于"] },
  { "name": "corrupt", "trans": ["adj. 腐败的,堕落的 vt. 使...恶化,贿赂,使...腐烂 vi. 腐烂,堕落"] },
  { "name": "buy", "trans": ["n. 合理的价格,购买 vt. 买,换得,收买,接受 vi. 购买"] },
  { "name": "increase", "trans": ["v. 增加, 提高 n. 增加, 增强, 提高"] },
  {
    "name": "host",
    "trans": ["n.[计算机]主机； 主人，东道主； 节目主持人； 酒店业主 vt.当主人； 主办宴会，主持节目； 款待，做东 vi.做主人，做东道主"]
  },
  { "name": "sample", "trans": ["n. 样品,标本 vt. 采样,品尝 adj. 样例的"] },
  { "name": "pending", "trans": ["adj. 待定的,即将发生或来临的 prep. 直到,等待...的时候,在...期间"] },
  { "name": "divide", "trans": ["vt.& vi.分； 划分； 分离； （使）产生分歧 n.分水岭，分界线； 分配"] },
  {
    "name": "boot",
    "trans": [
  ...
  { "name": "leading", "trans": ["n. 领导, 疏导, 铅板 adj. 领导的, 主要的, 在前的 vbl. 领导, 引领, 以铅接合 [计算机] 行间空白"] },
  { "name": "wrong", "trans": ["adj. 错误的,不正当的,失常的 adv. 错误地 n. 错误,不公正 vt. 伤害,亏待,欺骗,中伤"] },
  { "name": "today", "trans": ["n.&amp;adv. 今天"] },
  { "name": "least", "trans": ["adj. 最少的,最小的 n.&amp;adv. 最少,最小"] },
  { "name": "opposite", "trans": ["adj. 相对的, 相反的, 对面的 n. 对立物，对立者，对手 adv. 在对面地，处于相反位置地 prep. 在...对面"] },
  { "name": "white", "trans": ["adj. 白色的,白种的,纯洁的,幸运的 n. 白色,白种人"] },
  { "name": "override", "trans": ["vt. 弃绝,渺视,凌驾,过度负重 n. 给代理人的佣金,滥用 [计算机] 废除"] },
  { "name": "brown", "trans": ["adj. 褐色的,棕色的 n. 褐色,棕色 (姓)布朗"] },
  { "name": "hex", "trans": ["v. 施法，诅咒 n. 施法的人 abbr. (=hexagon) 六边形 abbr. (=hexadecimal) 十六进制"] },
  {
    "name": "rest",
    "trans": [
  ...
  { "name": "reserved", "trans": ["v. 保留(预定,推迟) adj. 保留的(预订的,冷淡的,缄默)"] },
  { "name": "technology", "trans": ["n. 技术,工艺(学)"] },
  { "name": "handle", "trans": ["n. 柄,把手 vt. 买卖,处理,操作 vi. 驾驭"] },
  { "name": "apply", "trans": ["vt. 应用, 申请; 涂 vt. 使专心从事 vi.申请; 有关联"] },
  { "name": "stand", "trans": ["n. 站立,停顿,楼台,货摊  vi. 站立,位于，停滞  vt. 忍受,使站立"] },
  { "name": "payment", "trans": ["n. 支付, 付款"] },
  { "name": "kilobyte", "trans": ["n. [计]千字节(1024字节)"] },
  { "name": "parenthesis", "trans": ["n. 圆括号, 插入语, 插曲，间歇,停歇"] },
  { "name": "scan", "trans": ["vt. 扫描；浏览；细看；详细调查；标出格律 vi. 扫描；扫掠 n. 扫描；浏览；审视；细看"] },
  ...
  { "name": "front", "trans": ["n.前面； 正面； 身体前部； 前线 adj.前面的； 正面的； 舌前的 v.面向； 在…前面； 用…作正面； 领导"] },
  { "name": "prefix", "trans": ["n. 前缀 vt. 加...作为前缀,置于前面 adj. 前缀的"] },
  { "name": "carousel", "trans": ["n. 旋转木马, （机场的）行李传送带 =carrousel"] },
  { "name": "safety", "trans": ["n.安全； 安全性； 安全处所； 中卫 adj.保障安全的"] },
  { "name": "static", "trans": ["n. 静电, 静电干扰, 噪声, 阻碍, 抨击 adj. 静态的,静电的,固态的"] },
  { "name": "fact", "trans": ["n. 实际, 事实"] },
  { "name": "alter", "trans": ["v. 改变"] },
  { "name": "track", "trans": ["n. 小路, 跑道, 轨道, 踪迹; 惯例, 常规 v. 跟踪, 追踪"] },
  { "name": "precedence", "trans": ["n. 优先, 居先"] },
  { "name": "skeleton", "trans": ["n. 骨架,纲要,骨骼,骨瘦如柴的人或动物,家丑 adj. 骨骼的"] },
  { "name": "log", "trans": ["n. 记录,圆木,日志,计程仪 vt. 伐木,切,记录,航行,度过(时间) vi. 采伐"] },
  { "name": "star", "trans": ["n. 星, 明星 v. 以星状物装饰, 变成演员"] },
  { "name": "hot", "trans": ["adj. 热的,热情的,辣的,性感的 adv. 激动地,快速地 n. 最高温度,滚烫的东西"] },
  ...
  {
    "name": "green",
    "trans": ["adj.绿色的； 未熟的，青春的； 未成熟的； 主张保护环境的 n.绿色蔬菜； 绿色的衣服； 植物 vi.绿化，使重视环境保护问题"]
  },
  { "name": "entirely", "trans": ["adv. 完全地"] },
  { "name": "helpful", "trans": ["adj. 有帮助的, 有益的"] },
  {
    "name": "middle",
    "trans": ["n.中部，中间； 腰部； 中央； 正中 adj.中部的； 中央的； 正中的； 中间的 vt.把…放在中间； 把…对折 vi.放在中间； 对折"]
  },
  { "name": "declared", "trans": ["adj. 承认的, 公告的 动词declare的过去式和过去分词"] },
  { "name": "compress", "trans": ["vt. 压缩, 压榨 n. [医]敷布"] },
  { "name": "graphically", "trans": ["adv. 用图表表示地"] },
  { "name": "auto", "trans": ["n. autos=automobile 自动汽车 pref. 自动的,自己的"] },
  { "name": "automatic", "trans": ["n. 自动装置, 半自动武器 adj. 自动的,机械的,半自动化的"] },
  { "name": "anywhere", "trans": ["adv. 任何地方 pron. 任何(一个)地方"] },
  { "name": "terminal", "trans": ["n. n. 终端机,终点,末端 adj. 终点的,晚期的,致死的"] },
  { "name": "door", "trans": ["n. 门"] },
  ...
  { "name": "critical", "trans": ["adj.批评的，爱挑剔的； 危险的，危急的； 决定性的； [物]临界的"] },
  { "name": "manager", "trans": ["n. 经理"] },
  { "name": "capability", "trans": ["n. 能力,才能,性能,容量"] },
  { "name": "affected", "trans": ["adj. 受到影响的；做作的；假装的 vt. 影响；假装；使…感动（affect的过去式和过去分词）"] },
  { "name": "border", "trans": ["n. 边缘 vt. 作...之疆界,加边"] },
  { "name": "cache", "trans": ["n. 电脑高速缓冲存储器；贮存物；隐藏处 vt. 隐藏；窖藏 vi. 躲藏"] },
  { "name": "bell", "trans": ["n. 钟,铃,花冠,吼叫声 vt. 敲钟,使象钟状地张开 vi. 使呈钟状,张开"] },
  { "name": "play", "trans": ["n. 游戏,游玩,剧本,比赛,比赛中的动作,影响 vt. &vi. 玩,进行比赛,演奏,播放,捉弄,假装"] },
  { "name": "quickly", "trans": ["adv. 快, 迅速"] },
  { "name": "fastback", "trans": ["快速返回"] },
  { "name": "answer", "trans": ["vt.& vi.答复； 解答； 答辩； 适应 n.回答； 答案； 反应； 足以媲美的人"] },
  { "name": "represent", "trans": ["vt. 表现, 表示, 描绘, 代表 vi. 提出异议"] },
  { "name": "difference", "trans": ["n. 差异,分歧 vt. 引起区别"] },
  { "name": "project", "trans": ["n. 工程,项目,计划,事业 v. 计划,设计,表达 v. 投射,放映,凸出"] },
  { "name": "physical", "trans": ["adj. 身体的,物理的,物质的 n. 体检"] },
  { "name": "matter", "trans": ["n. 事件, 物质, 原因 vi. 有关系"] },
  { "name": "hercules", "trans": ["n.大力英雄,力士,武仙座"] },
  { "name": "reduce", "trans": ["vt.换算； 约束； 使变为； 使变弱 vi.减少； 减轻体重； [生物学]（细胞）减数分裂； （液体）浓缩变稠"] },
  { "name": "publisher", "trans": ["n. 出版者, 发行人"] },
  {
    "name": "trim",
    "trans": ["n. 整齐,装饰,修剪下来的部分   adj. 整洁的,匀称的 adv. 整齐地 vt. 修除,削剪,装备,痛打,击败, 使整洁 vi. 保持平衡, 见风使舵"]
  },
  { "name": "substitute", "trans": ["n. 代替者,代用品 v. 代替 vi. (for)代替 vt. 用...代替,代以"] },
  { "name": "disabled", "trans": ["adj. 残废的 n. 残疾人"] },
  { "name": "recent", "trans": ["adj. 近来的, 新近的"] },
  { "name": "positive", "trans": ["adj. 肯定的, 积极的, 绝对的 adj. 正面的, 正数的, 阳性的"] },
  { "name": "upgrade", "trans": ["vt. 提高(上升,浓集,加强) n. 提高(上升,浓集,加强)"] },
  { "name": "instance", "trans": ["n.例子，实例； 情况； 要求，建议； [法]诉讼手续 vt.举…为例"] },
  ...
  {
    "name": "mono",
    "trans": ["pref. 表示“一”“单一” adj. (唱片等)单声道的 n. 单声道唱片 n. (=infectious mononucleosis) 传染性单核细胞增多症"]
  },
  { "name": "slide", "trans": ["n. 滑,幻灯片,雪崩,山崩,滑坡,滑梯 vt. 使滑 vi. 滑,跌落"] },
  { "name": "abort", "trans": ["v. 流产, 打胎, 堕胎"] },
  { "name": "jump", "trans": ["n. 跳跃,跳动,上涨 vt. &vi. 跳越,突升,惊跳"] },
  { "name": "toward", "trans": ["prep. 对于,关于,接近,将近,向,朝 adj. 有希望的,有利的,逼近的"] },
  { "name": "throughout", "trans": ["adv. 到处, 自始至终 prep. 遍及, 贯穿"] },
  { "name": "via", "trans": ["prep. 经由"] },
  { "name": "among", "trans": ["prep. 在...之中"] },
  { "name": "neither", "trans": ["adj. 皆不,两者都不 int. 两者都不 conj. 既非,既不"] },
  {
    "name": "layer",
    "trans": [
  ...
  { "name": "scatter", "trans": ["n. 散布, 零星少量 vt. 驱散, 散播 vi. 分散, 消散"] },
  { "name": "attention", "trans": ["n. 注意(力),关心,立正"] },
  { "name": "convention", "trans": ["n.会议； 全体与会者； 国际公约； 惯例，习俗，规矩"] },
  { "name": "conventional", "trans": ["adj. 普通的,常见的,习惯的,常规的"] },
  { "name": "tool", "trans": ["n. 工具,用具,受人利用的人,印压的图案 vt. 驾驶,用工具加工,印压图案于 vi. 驾驶,用工具加工"] },
  { "name": "processor", "trans": ["n. 加工者,处理器"] },
  { "name": "desktop", "trans": ["n. 桌面，台式电脑 adj. 台式的，桌上用的"] },
  { "name": "build", "trans": ["vt. &vi. 建造，创建，开发，逐渐增强 n. 体格，身材"] },
  ...
  { "name": "meet", "trans": ["n. 集会,比赛, 运动会 adj. 适宜的,合适的 vt. 遇见,引见,经历,结识,对付,满足,支付 vi. 相遇,集合,交锋,相交"] },
  { "name": "protect", "trans": ["vt. 保护,投保 vi. 提供保护"] },
  { "name": "reserve", "trans": ["n. 预备品, 贮存, 候补 n. 克制, 含蓄 vt. 保留, 预订, 延期"] },
  { "name": "clock", "trans": ["n. 时钟, 计时器"] },
  { "name": "manifest", "trans": ["n. 载货单,运货单,旅客名单 adj. 显然的,明白的 vt. 显示, 证实, 出示"] },
  ...
  { "name": "ring", "trans": ["n. 环, 戒指, 铃声, 圈 vt. 包围, 挂铃铛 vi. 鸣响, 回响, 在空气中螺旋上扬, 形成圈"] },
  ...
  { "name": "truncate", "trans": ["vt. 切去头端，缩短，截棱成平面 adj. 切去了头，缩短了的，截形的"] },
  ...
  { "name": "register", "trans": ["v. 记录, 登记, 注册, 挂号 n. 暂存器, 记录, 登记簿 n. (语)语域; 通风调节设备"] },
  { "name": "stuff", "trans": ["n. 材料, 原料, 东西 n. 素质, 本质; 废物 vt. 填满, 塞满"] },
  { "name": "exclude", "trans": ["vt. 除外,排除,拒绝 [计算机] 排除"] },
  { "name": "destroy", "trans": ["vt. &vi. 破坏,毁坏 [计算机] 撤消"] },
  { "name": "calculation", "trans": ["n. 计算"] },
  { "name": "angle", "trans": ["n. 角(度),角落 vt. 斜移,转变角度 vi. 钓鱼,谋取,转变角度 n. (Angle)盎格鲁人"] },
  ...
  { "name": "market", "trans": ["n. 市场,交易,推销地区 vt. 在市场上交易,使...上市 vi. 在市场上买卖"] },
  ...
  { "name": "grey", "trans": ["adj. 灰色的 n. 灰色(的) v. 变成灰色 [=gray] vi. 变成灰色"] },
  ...
  { "name": "derelict", "trans": ["adj. 被抛弃了的,无主的,玩忽职守的 n. 遗弃物,被遗弃的人,玩忽职守者"] },
  { "name": "redirect", "trans": ["adj. 再直接的 v. 重新传入, 重新寄送"] },
  { "name": "reside", "trans": ["v. 住,居留,属于"] },
  { "name": "header", "trans": ["n. 装盖者，割穗机，顶梁，集管 n.[体]头球，头先入水的跳水姿势 n.[计]页眉"] },
  { "name": "extra", "trans": ["adj. 额外的 adv. 特别地 n. 额外的事物，另外收费的"] },
  { "name": "repeated", "trans": ["adj. 重复的, 再之的 动词repeat的过去式和过去分词形式"] },
  ...
  { "name": "master", "trans": ["n. 主人, 硕士, 母机 adj. 主人的, 主要的 v. 征服, 控制, 精通"] },
  { "name": "recursive", "trans": ["adj. 递归的，循环的"] },
  { "name": "trap", "trans": ["n. 圈套,陷阱,困境,双轮轻便马车  vt. &vi. 设圈套,设陷阱"] },
  ...
  { "name": "rule", "trans": ["n. 惯例,规则,统治 v. 裁定,统治,支配 vi. 裁决,统治 vt. 统治"] },
  { "name": "flag", "trans": ["n. 旗标,旗子,信号旗 vt. 打旗号 vi. 无力地下垂,减退"] },
  { "name": "criterion", "trans": ["n. 标准, 准则"] },
  { "name": "office", "trans": ["n. 办公室，职务，事务"] },
  { "name": "express", "trans": ["n. 快车, 快递, 专使 adj. 急速的, 明确的, 直接的 adv. 用快递; 特意地 vt. 表达, 表示; 挤压出; 快递"] },
  { "name": "volume", "trans": ["n. 体积, 容量, 音量 n. 卷, 册"] },
  { "name": "soft", "trans": ["adj. 柔软的,温和的,不强烈的,细腻的,轻的 adv. 柔软地,温和地 n. 柔软的东西"] },
  ...
  { "name": "trace", "trans": ["n. 痕迹,踪迹,微量 vt. 追踪,找出根源,描绘 vi. 追踪"] },
  ...
  {
    "name": "near",
    "trans": ["adj. 接近的,近亲的,亲近的,勉强的,直接的,小气的,近似的 adv. 接近,几乎,亲近 prep. 靠近 vt. 靠拢,接近 vi. 接近"]
  },
  { "name": "fifth", "trans": ["num. 第五 n.五分之一"] },
  { "name": "seven", "trans": ["num. 七"] },
  { "name": "whereas", "trans": ["conj.&amp;adv. 然而,却,反之"] },
  { "name": "review", "trans": ["n. 检讨, 复习, 回顾, 评审 vt. 温习, 检讨, 评论, 检阅 vi. 写评论"] },
  { "name": "transform", "trans": ["vt. 转换,变形 vi. 改变 n. 变形"] },
  { "name": "align", "trans": ["vt. 使成一行, 使一致, 使结盟, 调整, 排列 vi. 成一条线"] },
  { "name": "yellow", "trans": ["adj. 黄色的 n. 黄色"] },
  { "name": "assist", "trans": ["n. 帮助,协助,协助的器械 vt. 帮助,协助 vi. 帮助,协助,出席"] },
  { "name": "finish", "trans": ["n. 完成,最后加工,结局,完美 vt. 结束,获...第几名 vi. 终结,完成"] },
  { "name": "micro", "trans": ["adj. 微小的 n. 微米(百万分之一, 测微计)"] },
  { "name": "beyond", "trans": ["adv. 在更远处,另外 n. 远处, 来世 prep. 超出, 越过,另外"] },
  { "name": "against", "trans": ["prep. 反对,倚靠,违背,防御,相比,相对"] },
  { "name": "upon", "trans": ["prep. 在...上"] },
  { "name": "service", "trans": ["n. 服务, 公务部门, 服役, 发球, 发球方式 vt. 维护, 保养"] },
  { "name": "little", "trans": ["adj. 小的 adv. 毫不，少量地 n. 几乎没有（指数量或程度等）"] },
  { "name": "exhaust", "trans": ["n. 排气,排气装置 v. 用尽,耗尽,使...精疲力尽 [计算机] 排除"] },
  { "name": "choice", "trans": ["adj. 上等的,精选的 n. 选择,挑选"] },
  { "name": "sounding", "trans": ["n. 探测水的深度, 试探 adj. 发声的, 夸大的 动词sound的现在分词形式"] },
  { "name": "develop", "trans": ["vt. 发展,开发,冲洗照片 vi. 进步"] },
  { "name": "holding", "trans": ["n. 把持, 支持, 保持 vbl. 握住, 把持, 举行"] },
  { "name": "alpha", "trans": ["n. 希腊字母的第一个字母，最初，开端 adj. [化]阿尔法位的，主导的，首要的，按字母顺序的"] },
  { "name": "constant", "trans": ["adj. 经常的, 不变的 n. 常数, 恒量"] },
  { "name": "warranty", "trans": ["n. 担保,保证,根据"] },
  { "name": "stay", "trans": ["n. 停留,停止;依靠,忍耐力;撑条 vt. 等待,坚持到底 vi. 保持,停留,留宿"] },
  { "name": "industry", "trans": ["n. 工业,产业,勤勉,刻苦"] },
  { "name": "trigger", "trans": ["vt. 引发，引起；触发 vi. 松开扳柄 n. 扳机；[电子] 触发器；制滑机"] },
  ...
  { "name": "whole", "trans": ["adj. 整个的, 完全的, 未受损的, (人)全面发展的 n. 全部, 通常情况 adv. 完全地, 统一地"] },
  ...
  { "name": "dynamic", "trans": ["adj. 动态的, (有)动力的, (有)力的; 有活力的 n. 动力; 力学"] },
  ...
  { "name": "vice", "trans": ["n. 恶习,恶行,罪恶,缺陷,恶癖,老虎钳 vt. 钳住 prep. 代替,副,次"] },
  ...
  { "name": "extract", "trans": ["n. 榨出物,精华,摘录 vt. 拔出,榨出,摘录,提取,选取 [计算机] 提取"] },
  { "name": "unrecognized", "trans": ["adj. 未被承认的, 未被认出的"] },
  { "name": "thereafter", "trans": ["adv. 其后, 从那时以后"] },
  { "name": "inverse", "trans": ["adj. 相反的,倒转的 n.   相反的事物,(数学)逆反函数, 倒数, 负数"] },
  { "name": "spell", "trans": ["v. 拼写，缓慢地或吃力地读 n. 魅力，符咒 vt. 用符咒镇住(某人) n. 一段时间，轮班 v. 轮班，休息"] },
  { "name": "limiting", "trans": ["adj. 限制的 动词limit的现在分词"] },
  { "name": "restructure", "trans": ["v. 更改结构, 重建构造"] },
  { "name": "delimit", "trans": ["vt. 定界限, 划界"] },
  { "name": "pay", "trans": ["n. 薪资,付款,报偿 vt. 支付,付清,报偿,给予 vi. 债清，值得，承担后果 adj. 投币的，要钱的"] },
  { "name": "separately", "trans": ["adv. 分别地；分离地；个别地"] },
  { "name": "classify", "trans": ["v. 分类,归类,分等"] },
  { "name": "interfere", "trans": ["vi. 妨碍,冲突,干涉"] },
  { "name": "mind", "trans": ["n. 思想, 主意, 心意, 记忆, vt. 留心, 注意, 介意, 照顾 vi. 留心, 关心"] },
  { "name": "individually", "trans": ["adv. 个别地，单独地，独特地"] },
  { "name": "vertical", "trans": ["adj. 垂直的,顶点的,纵向的 n. 垂直物, 垂直的位置"] },
  { "name": "undesirable", "trans": ["adj. 不受欢迎的, 不良的，不合意的，讨厌的 n. 不受欢迎的人，不良分子"] },
  { "name": "lot", "trans": ["adv. 很,非常 pron. 大量 n. 许多,量,小组,抽签,场地,命运 vt. 分配,划分"] },
  ...
  { "name": "map", "trans": ["n. 地图 v. 映射,绘制...之地图,计划 [计算机] 存储区分配图"] },
  { "name": "figure", "trans": ["n. 图形, 数字, 形状; 人物, 外形, 体型 v. 演算, 认为, 领会到"] },
  {
    "name": "prepare",
    "trans": [
  ...
  { "name": "mean", "trans": ["n.平均值, 平均数; 中部 adj. 低劣的, 卑贱的; 卑鄙的; 吝啬的 adj. 平均的, 中等的 v. 意味, 想要, 意欲"] },
  { "name": "salary", "trans": ["n. 薪水 vt. 给...薪水"] },
  { "name": "pacific", "trans": ["adj. 太平洋的,(pacific)热爱和平的,求和的, 和解的 n. 太平洋"] },
  { "name": "strong", "trans": ["adj. 强壮的, 牢固的, 坚定的, 坚强的, 强烈的, 浓的"] },
  { "name": "emphasize", "trans": ["v. 强调,着重 vt. 强调"] },
  { "name": "department", "trans": ["n. 部,部门,系"] },
  { "name": "forced", "trans": ["adj. 被迫的, 强迫的, 用力的，不自然的 force的过去式(分词）"] },
  { "name": "ANSI", "trans": ["abbr. 美国国家标准学会(=American National Standards Institute)"] },
  ...
  { "name": "tape", "trans": ["n. 录像带, 录音带, 磁带, 胶带 vt. 用带子捆起, 给...录音 vi. 录音"] },
  { "name": "concept", "trans": ["n. 概念, 观念"] },
  { "name": "optimize", "trans": ["v. 使...完美,乐观,使...完善 v.优化"] },
  { "name": "counter", "trans": ["n. 计算器,计算者,柜台  [计算机] 计数器 adj. 相反的  adv. 与…相反地  vt. 反对,反击  vi. 反对,反击"] },
  { "name": "expect", "trans": ["vt.期望； 预料； 要求； 认为（某事）会发生 vi.预期； 期待； 怀胎； 怀孕"] },
  ...
  { "name": "specialize", "trans": ["vi.专门从事； 专攻； 详细说明； 特化 vt.使专门化； 使适应特殊情况； 详细说明； 列举"] },
  { "name": "fail", "trans": ["vi. 衰退,失败,不及格 vt. 辜负,缺少,未能做 n. 不及格"] },
  { "name": "primarily", "trans": ["adv. 首先, 主要地"] },
  { "name": "client", "trans": ["n.顾客； 当事人； 诉讼委托人； [计算机]客户端"] },
  { "name": "runtime", "trans": ["[计] 运行时间"] },
  { "name": "fix", "trans": ["vt. &vi. 使...固定,修理,准备 n. 困境, (船只、飞机等的)定方位,贿赂"] },
  { "name": "author", "trans": ["n. 作者,创造者 vt. 创造,写作"] },
  { "name": "programmer", "trans": ["n.程序员, 程序规划员 ,节目编排者 =programer（英）"] },
  { "name": "commercial", "trans": ["adj. 商业的 n. 商业广告"] },
  { "name": "particularly", "trans": ["adv. 特别, 尤其"] },
  { "name": "low", "trans": ["n. 低,低点(价),深度,牛叫声 adj. 低的,消沉的,低等的,粗俗的,衰弱的 vi. 牛叫"] },
  { "name": "sheet", "trans": ["n. 床单,张,片 vt. 盖上被单,遍布, 使成片状 vi. 成片落下或流动 adj. 片状的"] },
  ...
  { "name": "involved", "trans": ["v. 涉及(包含,遍及,占用,促成,自乘) adj. 所包含的(形式复杂的)"] },
  { "name": "conditional", "trans": ["adj. 有条件的, 假定的，假设的 n. [语]条件句"] },
  ...
  { "name": "showing", "trans": ["n. 显示, 放映 动词show的现在分词"] },
  ...
  { "name": "replicate", "trans": ["vt. &vi. 折叠,复制,模写 n. 同样的样品 adj. 转折的"] },
  ...
  { "name": "remainder", "trans": ["n. 剩余物, 其他的人, 残余 vt. 廉价出售 adj. 剩余的"] },
  ...
  {
    "name": "gap",
    "trans": ["n. (意见、个性等的)差异,缝隙,漏洞,缺口 vt. 制造缺口 嘉普(财富500强公司之一，总部所在地美国,主要经营服装零售)"]
  },
  { "name": "indexing", "trans": ["n. 指数(分度, 索引, 转位, 转换角度, 换档, 改址)"] },
  {
    "name": "board",
    "trans": ["n. 木板, 甲板, 董事会 n. 伙食; 舞台, 演员的职业; 船舷 vt. 登(飞机、车、船等); 有偿提供食宿; 用木板覆盖 vi. 搭伙"]
  },
  { "name": "package", "trans": ["n. 包裹,整批交易  vt. 把...打包,把...进行推销"] },
  { "name": "insertion", "trans": ["n. 插入,刊载,插入物"] },
  { "name": "intervene", "trans": ["vi. 插入,介入,干涉,调停 [计算机] 介入"] },
  { "name": "conflict", "trans": ["n.冲突； 战斗； 相互干扰； 矛盾 vi.抵触； 争斗； 战斗； 冲突"] },
  { "name": "really", "trans": ["adv. 真正地,实在，事实上"] },
  { "name": "overflow", "trans": ["n. 溢值,超值,泛滥 v. 泛滥,溢出,充溢 [计算机] 溢出"] },
  { "name": "charge", "trans": ["n. 电荷, 指控, 费用; 照顾, 责任 vt. &vi 控诉, 加罪于, 要价, 赊帐, 充电, 管理"] },
  ...
  { "name": "familiar", "trans": ["adj. 熟悉的,熟知的,不拘礼节的 n. 熟人,熟悉某种事物的人"] },
  { "name": "Mach", "trans": ["n. [物]马赫（速度单位） n. 马赫(奥地利物理学家, 心理学家、哲学家) abbr. 机器（=machine）"] },
  { "name": "incorrect", "trans": ["adj. 不正确的, 错误的"] },
  { "name": "cut", "trans": ["n. 切口,割伤,降低,份额,删节,割下的一块肉 vt. 切割,减少,停止,修剪 vi. 切割,快速移动 [计算机] 剪掉"] },
  { "name": "lowest", "trans": ["adj.最低的,最底下的,最小的"] },
  { "name": "simple", "trans": ["adj. 简单的,无辜的,天真的,基本的,纯粹的 n. 平民,精神病人,草药"] },
  { "name": "subsequent", "trans": ["adj. 随后的,后来的"] },
  { "name": "compact", "trans": ["adj. 紧凑的,紧密的,简洁的 v. 使装满,使简洁"] },
  { "name": "plain", "trans": ["n. 平原,草原 adj. 简单的,平坦的,平常的,家常的 adj.纯的，不掺杂的"] },
  { "name": "noted", "trans": ["adj. 著名的，有声望的 动词note的过去式和过去分词形式"] },
  { "name": "desirable", "trans": ["adj. 值得有的,令人满意的,有吸引力的 n. 有吸引力的人"] },
  { "name": "substitution", "trans": ["n. 代理,替换,交换"] },
  { "name": "consume", "trans": ["vt.  消耗，毁灭，吃，喝, 挥霍 vi. 耗尽生命, 被烧毁"] },
  ...
  { "name": "manufacture", "trans": ["n. 产品,制造,制造业 vt. 制造,加工 vi. 参与制造"] },
  { "name": "hundred", "trans": ["n. 百,百个东西 adj. 百,百个"] },
  { "name": "thousand", "trans": ["adj. 千,成千"] },
  { "name": "twentieth", "trans": ["n. 二十分之一 num.&amp;adj. 第二十"] },
  { "name": "understanding", "trans": ["n. 了解, 理解, 个人见解, 非正式协议, 谅解, 同情心, 洞察力 adj. 有同情心的"] },
  { "name": "hand", "trans": ["n. 手,掌握,协助 vt. 帮助,给 adv. 手动地,人工地"] },
  { "name": "fancy", "trans": ["n. 想像力, 幻想, 喜好, 爱 adj. 想像的, 时髦的, 华丽装饰的, 奢侈的, 技巧的 vt. 想象, 自认为, 喜好"] },
  ...
  { "name": "worry", "trans": ["n. 烦恼,忧虑,苦恼 vt. 使...烦恼,使...焦虑, 叼住某物甩或拉 vi. 感到苦恼,感到焦虑"] },
  { "name": "quiet", "trans": ["n. 安静,闲适,平静 adj. 安静的,静止的,宁静的 adv. 安静地 vt. &vi. 使...平静,使...安心"] },
  { "name": "purge", "trans": ["n. 整肃,清除,泻药,净化 vt. 净化,清除,摆脱 vi. 清除,通便,腹泻,变得清洁"] },
  { "name": "mod", "trans": ["abbr. (=modern) 现代的，时髦的 abbr. (=modulus) 模数，绝对值"] },
  { "name": "numeral", "trans": ["adj. 数字的, 表示数字的 n. 数字, 数"] },
  { "name": "whichever", "trans": ["adj. 无论哪个, 无论哪些 pron. 无论哪个"] },
  { "name": "purchase", "trans": ["n. 购买, 购买的物品 n. 支点; 紧握, 抓紧 vt. 购买, 赢得; (用设备)举起, 移动"] },
  {
    "name": "care",
    "trans": [
  ...
  { "name": "watch", "trans": ["n. 手表,注视 vt. 观察,监视,注视,照顾,等待 vi. 留意,观察"] },
  { "name": "endeavor", "trans": ["n. 努力, 尽力, 进取心 vt. 努力,尽力 vi. 企图, 谋求"] },
  { "name": "mismatch", "trans": ["vt. 配错, 配合不当 n. 配错, 不相匹配"] },
  { "name": "printout", "trans": ["n. (电脑)打印输出"] },
  { "name": "ellipsis", "trans": ["n. 省略"] },
  { "name": "ship", "trans": ["n. 船,舰,船员,飞船 vt. 以船运送,乘船,运送,进水,在船上工作 vi. 上船,坐船,运送,在船上工作"] },
  { "name": "British", "trans": ["adj. 英国的 n. 英国人, 英国英语"] },
  { "name": "parallel", "trans": ["adj. 平行的,相同的,类似的,并联的 adv. 平行地 n. 平行线(面),相似物,对比 vt. 相比,相应,与...平行"] },
  ...
  { "name": "implement", "trans": ["n. 工具, 器具; 当工具的物品 vt. 实施, 执行; 向...提供工具(或手段)"] },
  { "name": "effort", "trans": ["n. 努力, 努力的成果"] },
  { "name": "worker", "trans": ["n. 工人，工作者"] },
  { "name": "ampersand", "trans": ["n. 和，＆(and 的符号）"] },
  { "name": "deal", "trans": ["n. 交易,协定,份量 v. (dealt,dealt[delt])处理,应付,分配"] },
  { "name": "power", "trans": ["n. 力量, 权力，电力 vt. 供电，激励，全速前进 adj. 与力量有关的，与权力有关的，电力控制的"] },
  { "name": "difficulty", "trans": ["n. 困难，争议，反对，麻烦"] },
  { "name": "lose", "trans": ["vt. 遗失,损失,失败,摆脱 vi. 丢失,失败 [计算机] 失去"] },
  { "name": "magic", "trans": ["adj. 有魔力的, 神奇的 n. 魔法, 魔术 vt. 使用魔(变出等)"] },
  ...
  { "name": "revolutionize", "trans": ["vt. 使革命化，使彻底变革  vi. 变革 =revolutionise（英）"] },
  ...
  { "name": "security", "trans": ["n.安全； 保证，担保； 保护，防护； 有价证券 adj.安全的，保安的，保密的"] },
  { "name": "touch", "trans": ["n. 触觉,接触,少许, 痕迹, 修饰 vt. 触摸,吃,喝,触及,感动 vi. 接触, 联系"] },
  { "name": "contrast", "trans": ["n.对比，对照； 差异； 对照物，对立面； [摄]反差"] },
  { "name": "invent", "trans": ["v. 发明 vt. 发明,创造"] },
  { "name": "reflect", "trans": ["v. 反映, 反射, 归咎"] },
  { "name": "undone", "trans": ["adj. 未完成的，未做完的 动词undo的过去分词形式"] },
  ...
  {
    "name": "cost",
    "trans": ["n.价钱，代价； 花费，费用； 牺牲； [用复数][法律]诉讼费 vi.价钱为，花费； 估计成本 vt.付出代价； 估价； 使丧失； 使付出努力"]
  },
  { "name": "degrade", "trans": ["vt. 贬低；使……丢脸；使……降级；使……降解 vi. 降级，降低；退化"] },
  { "name": "suggestion", "trans": ["n. 建议, 意见, 迹象, 暗示, 联想"] },
  { "name": "real", "trans": ["adj. 实际的,现实的,真的,真实的 adv. 非常 n. 真实的事, 真实"] },
  { "name": "experimentation", "trans": ["n. 实验, 试验"] },
  { "name": "experiment", "trans": ["n. 实验,试验,尝试 vi. 做实验,尝试"] },
  { "name": "substantial", "trans": ["n. 重要部份, 本质 adj. 大量的, 实质上的, 有内容的"] },
  { "name": "solely", "trans": ["adv. 独自地,单独地"] },
  { "name": "announce", "trans": ["vi.宣布参加竞选； 当播音员 vt.宣布； 述说； 声称； 预告"] },
  { "name": "squeeze", "trans": ["n. 压榨,榨出的少量,佣金,经济拮据 vt. 紧握,挤压,使经济困难 vi. 让步,压迫,险胜"] },
  { "name": "distribute", "trans": ["vt. &vi. 分配,散布"] },
  { "name": "negate", "trans": ["v. 否定, 否认, 打消"] },
  { "name": "capture", "trans": ["n. 抓取,战利品,捕获之物 vt. 抓取,获得,迷住"] },
  { "name": "father", "trans": ["n. 父亲,鼻祖 vt. 作为父亲生育子女 vi. 像父亲般照顾"] },
  { "name": "reinstate", "trans": ["v. 恢复(原职) vt. 使恢复原有的职位"] },
  { "name": "tutorial", "trans": ["n. 个别指导 adj. 个别指导的"] },
  { "name": "nicety", "trans": ["n. 精确，谨慎，精细，细微的区别"] },
  { "name": "roll", "trans": ["vt.辗； 使（眼球等）左右转动； （使）原地转圈； 滚动 vi.左右摇晃； 翻滚； 开始移动，启动 n.名册； 滚翻"] },
  { "name": "exponent", "trans": ["n. 拥护者，说明者，楷模 n. 指数 n. 能手，大师 adj. 说明的"] },
  { "name": "exponential", "trans": ["adj. 指数的 n. 指数"] },
  { "name": "prefer", "trans": ["vt.更喜欢； 提升，提拔； 给予（债权人）优先权； 提出（控告） vi.更喜欢，宁愿"] },
  ...
  { "name": "very", "trans": ["adj. 真正的,完全的,自己的,仅仅的,同一个,特别的 adv. 真的,非常"] },
  { "name": "unnecessary", "trans": ["adj. 不必要的,多余的 n. 不必要的东西"] },
  { "name": "unchanged", "trans": ["adj. 无变化的"] },
  { "name": "cross", "trans": ["n. 十字架,十字架形物件,交叉,交叉路 adj. 生气的,交叉的 vt. 划叉剔除，画横线于 vi. 穿越 prep. 穿过"] },
  ...
  { "name": "nothing", "trans": ["adv. 毫不 n. 微不足道的人或事 pron. 什么也没有"] },
  ...
  { "name": "think", "trans": ["vt.想； 思索； 以为； 看待 vi.思辩； 考虑； 构想； 回忆 adj.深思的； 供思考的 n.想； 想法"] },
  ...
  { "name": "smooth", "trans": ["adj. 平稳的,流畅的,安祥的,圆滑的,搅拌均匀的 vt. 使光滑,磨光,安慰,理顺(羽毛) vi. 变光滑"] },
  { "name": "attached", "trans": ["adj. 附加的, 固定的"] },
  { "name": "average", "trans": ["n. 平均数,平均水平 adj. 一般的,通常的,平均的 vt. &vi. 取平均值，达到平均水平"] },
  { "name": "quietly", "trans": ["adj. 寂静地, 静止地 adv. 安静地, 平静地"] },
  { "name": "discard", "trans": ["n. 丢牌,废牌 vt. 丢弃,抛弃 vi. 丢牌"] },
  { "name": "never", "trans": ["adv. 从不,绝不"] },
  { "name": "initiate", "trans": ["n. 创始人 adj. 新加入的 vt. 开始,创始,启蒙,介绍加入"] },
  { "name": "powerful", "trans": ["adj. 强有力的"] },
  { "name": "purpose", "trans": ["n. 目的, 意图; 意志, 决心; 议题 vt. 打算, 决意"] },
  { "name": "regard", "trans": ["vt.认为； 注视； 涉及； 尊敬 vi.凝视； 留意 n.凝视； 留意； 尊敬； 问候"] },
  { "name": "daily", "trans": ["adj. 每日的, 按天计算的, 日常的 adv. 每日,天天 n. 日报, (复)工作样片"] },
  ...
  { "name": "guard", "trans": ["n. 守卫者,警戒, 护卫队, 保护 vt. &vi. 保卫,看守,警惕"] },
  ...
  { "name": "glance", "trans": ["vi.一瞥； 闪微光； 掠过，擦过； 随便提到，简略地触及 n.浏览； 闪光； 歪斜，一掠"] },
  { "name": "happening", "trans": ["n. 偶然发生的事 动词happen的现在分词形式"] },
  { "name": "transaction", "trans": ["n. 交易,处理,办理"] },
  { "name": "emulation", "trans": ["n. 效法, 竞争，模仿"] },
  { "name": "strike", "trans": ["n. 罢工, 打击, 殴打 v. 打, 撞, 罢工, 划燃"] },
  { "name": "dump", "trans": ["n. 垃圾场,堆放处 vt. 丢弃,抛售,导出 vi. 骤降,扔垃圾"] },
  ...
  { "name": "logged", "trans": ["adj. 记录的, 进水的, 锯成圆木的，沉重的 动词log的过去式及过去分词形式"] },
  { "name": "ware", "trans": ["n. 制品,器具,货物 vt. 留心,意识到 adj. 知道的,意识到的"] },
  { "name": "disregard", "trans": ["n. 不理会, 漠视 vt. 忽视, 不顾"] },
  { "name": "waiting", "trans": ["n. 等候 adj. 候补 动词wait的现在分词"] },
  { "name": "preceding", "trans": ["adj. 在前的,在先的"] },
  { "name": "comparison", "trans": ["n. 比较"] },
  { "name": "advanced", "trans": ["adj. 高级的, 先进的"] },
  { "name": "rate", "trans": ["n. 比率, 等级, 价格 vt. 估价, 认为, 定等级; 责骂 vi. 受欢迎, 受推崇; 责骂"] },
  { "name": "fly", "trans": ["n. 苍蝇,两翼昆虫,飞行,升高 vt. &vi. 飞,飞翔,逃走,飞逝,猛然移动"] },
  { "name": "programmable", "trans": ["adj. 可编程的"] },
  { "name": "definable", "trans": ["adj. 可定义的, 可确定的"] },
  { "name": "readable", "trans": ["adj. 字迹易辨认的 adj. 可读的, 易读的, 读起来津津有味的"] },
  ...
  { "name": "defective", "trans": ["adj. 有缺陷的,欠缺,不完全变化动词 n. 有缺陷的人,不完全变化动词"] },
  ...
  { "name": "phrase", "trans": ["n. 短语,习语,个人风格,乐句 vt. 措词表达,将(乐曲)分成乐句(来演奏)"] },
  ...
  { "name": "major", "trans": ["n. 主修, 成年人, 陆军少校; 巨头 adj. 主要的, 较多的, 大部份的 vi. 主修"] },
  { "name": "higher", "trans": ["adj. 更高的"] },
  { "name": "wise", "trans": ["adj. 明智的,有学问的,有智慧的,聪明的 n. 方式 vt. 引导 vi. 学"] },
  { "name": "becoming", "trans": ["adj. 合适的，适当的，好看的 动词become的现在分词形式"] },
  { "name": "equally", "trans": ["adv. 相等地, 同样地, 平等地"] },
  { "name": "enjoy", "trans": ["vt. &vi. 享受,喜欢"] },
  { "name": "forth", "trans": ["adv.向前，向前方； 露着的，往外的； [废语]出外，离家 prep.出自，从…离开"] },
  { "name": "disappear", "trans": ["vi. 消失,灭绝 vt. 引起消失"] },
  { "name": "crop", "trans": ["n. 庄稼,收成, 一群,平头 vt. 割掉, 修剪, 剪短, 收割, 使谷物生长 vi. 啃青草, 种植谷物"] },
  { "name": "diagonally", "trans": ["adv. 斜对地, 对角地"] },
  { "name": "decision", "trans": ["n. 决定,决心"] },
  { "name": "effective", "trans": ["adj. 有效的,有影响的"] },
  { "name": "significant", "trans": ["adj. 有意义的, 意味深长的; 相当数量的; 重要的, 重大的 n. (复)有意义的事物; 标志"] },
  ...
  { "name": "craze", "trans": ["n. 狂热, 大流行，(陶瓷器等表面的)裂纹 v. (使)发狂, (使)产生裂纹"] },
  ...
  { "name": "nature", "trans": ["n.自然,自然界,自然状态; 本性,天性,性质; 质; 性格; 性; 本质"] },
  { "name": "natural", "trans": ["adj.自然的； 物质的； 天生的； 不做作的 n.自然的事情； （生来的）白痴； [乐]（风琴等的）白键"] },
  { "name": "grant", "trans": ["vt.承认； 同意； 准许； 授予 n.拨款； 补助金； 授给物（如财产、授地、专有权、补助、拨款等） vi.同意"] },
  ...
  { "name": "resolve", "trans": ["n. 决定之事,决心,坚决 vt. 决定,解决,分离,表决 vi. 分离,决定"] },
  ...
  { "name": "pool", "trans": ["n. 水塘(池),游泳池,撞球 vi. 形成池塘 vt. 集中,积累"] },
  { "name": "moment", "trans": ["n. 片刻，瞬间，准确时刻，非常重要的时机，力矩"] },
  { "name": "shut", "trans": ["adj. 关闭的,合拢的,围绕的 vt. 关上，防止进入，禁闭，合上，停止或中止 vi. 关闭，停止或中止 n. 关闭"] },
  { "name": "closed", "trans": ["adj. 关闭的,  封闭的,  停业的 动词close的过去式和过去分词"] },
  { "name": "respond", "trans": ["vi. &vt. 回复,反应，响应，应答 n. 拱柱"] },
  { "name": "repeating", "trans": ["adj. 重复的, 反复的 动词repeat的现在分词形式"] },
  { "name": "repetitive", "trans": ["adj. 重复的"] },
  { "name": "reenter", "trans": ["v. 重新进入"] },
  { "name": "rearrange", "trans": ["重新整理, 重新排序"] },
  { "name": "rectangular", "trans": ["adj. 矩形的；成直角的"] },
  { "name": "tag", "trans": ["n. 标签,附属物,名称,谚语 vt. 附以签条,尾随,添饰,指责,连接 vi. 紧随,尾随"] },
  { "name": "suppose", "trans": ["vt.假定； 猜想，推测； 认为； 让（用于祈祷语气） vi.想象，猜想"] },
  { "name": "supposed", "trans": ["adj. 想象上的，假定的"] },
  { "name": "operator", "trans": ["n. 操作员,管理者,技工,报务员"] },
  { "name": "masking", "trans": ["n. 遮蔽 动词mask的现在分词形式"] },
  { "name": "price", "trans": ["n. 价格,代价,价值 vt. 定格,标价,比较价格"] },
  { "name": "demonstrate", "trans": ["vt. 示范, 演示, 证明 vi. 示威"] },
  { "name": "importance", "trans": ["n. 重要,重要性"] },
  { "name": "pipe", "trans": ["n. 管,烟斗,笛 vt. 以管输送,装管道,吹奏,尖声说,拷边 vi. 吹奏管乐,尖叫"] },
  { "name": "overall", "trans": ["adj. 全部的, 全体的, 一切在内的 adv. 总的来说, 全部地 n. 防护服，罩衫"] },
  ...
  { "name": "clipper", "trans": ["n. 剪削者，大剪刀，理发剪 n. （十九世纪的）快速帆船 n. 快马"] },
  ...
  { "name": "assignment", "trans": ["n. 分配,功课,任务,被指定的(课外)作业;(分派的)任务, 委派"] },
  ...
  { "name": "due", "trans": ["adj.由于； 适当的； 预定； 到期 n.应有的权利； 应得到的东西； 应缴款 adv.正向； 正对着"] },
  ...
  { "name": "architecture", "trans": ["n. 建筑学, 建筑业, 建筑物, 结构  [总称]建筑物, 建筑风格"] },
  ...
  { "name": "cad", "trans": ["n. 卑鄙的男人，下流人 abbr. (=computer-aided design)计算机辅助设计"] },
  { "name": "arithmetic", "trans": ["n. 算术"] },
  { "name": "representative", "trans": ["adj. 代表性的, 代议制的, 典型的 n. 代表, 众议员, 典型"] },
  { "name": "typical", "trans": ["adj. 典型的, 有代表性的"] },
  { "name": "sufficient", "trans": ["adj. 足够的, 充分的"] },
  { "name": "blast", "trans": ["n. 爆破,冲击波,气流,一阵,汽笛声 vi. 爆破,突然发出声音 vt. 喷射,炸掉"] },
  { "name": "clean", "trans": ["adj. 干净的, 正当的, 纯洁的, 完全的, 精准的, 空的 adv. 完全地 n. 清洁 vt. &vi. 打扫,清扫"] },
  { "name": "caret", "trans": ["n. 脱字符号, ( 符号：^ 文章中插字使用)"] },
  { "name": "socket", "trans": ["n. 插座,插口, 穴孔 vt. 装上或插入插座"] },
  { "name": "stated", "trans": ["adj. 决定了的, 一定的, 定期的 v. 陈述, 说明 vbl. 陈述, 说明"] },
  { "name": "protocol", "trans": ["n. 草案, 协议,礼仪 vt 拟定议定书"] },
  { "name": "presence", "trans": ["n. 出席,在场者,举止"] },
  {
    "name": "telephone",
    "trans": ["n.电话； 电话机； （电话机的）话筒； 受话器 vt.& vi.以电话传送（消息），给（某人）打电话； 用电话与（某人）交谈"]
  },
  { "name": "social", "trans": ["adj. 社会的,群居的,社团的"] },
  { "name": "equipment", "trans": ["n. 设备,装备"] },
  { "name": "lending", "trans": ["n. 借贷, 借贷物 动词lend的现在分词形式"] },
  ...
  { "name": "aid", "trans": ["n. 帮助,救护,辅助物 vt. &vi. 援助,帮助,救护 abbr.=Agency for International Development 国际开发署[美]"] },
  { "name": "successive", "trans": ["adj. 接连的, 连续的, 接二连三的"] },
  { "name": "succession", "trans": ["n. 连续, 继承权, 继位"] },
  { "name": "unpack", "trans": ["vt. 打开取出, 卸下"] },
  { "name": "chunk", "trans": ["n. 厚块（片）, 相当大的量，矮胖的人或物 vt. （高尔夫球）没击中 vi. 发出猛冲的声音"] },
  { "name": "alignment", "trans": ["n. 队列，成直线；校准；结盟"] },
  { "name": "typewriter", "trans": ["n. n. 打字机"] },
  { "name": "big", "trans": ["adj. 大的,重要的 adv. 以郑重的方式,大数量 n. 杰出的组织和个人"] },
  { "name": "tone", "trans": ["n. 音调,语气,品质,调子,色调 vt. 使更健壮,装腔作势地说, 定调, 调色 vi. 调和(颜色), 呈现悦目色调"] },
  { "name": "sensitive", "trans": ["adj. 敏感的,灵敏的,易受伤害的,感光的,善解人意的  n. 敏感的人"] },
  ...
  { "name": "gain", "trans": ["n. 增益, 获得, 利润 vt. 得到, 增进, 获利 vi. 增加, 得到, (钟, 表等)走得快"] },
  { "name": "stream", "trans": ["n. (人,车,气)流,水流,组 vt. 流出,飘动 vi. 流动,飘动,接踵而来"] },
  { "name": "obsolete", "trans": ["adj. 已废弃的, 过时的"] },
  { "name": "accommodate", "trans": ["vi. 使自己适应 vt. 使一致，和解；提供方便；容纳；顾及"] },
  { "name": "motif", "trans": ["n. 主题, 意念, 动机"] },
  { "name": "subject", "trans": ["n. 科目, 主题; 缘由 n. (君主国)国民; 实验对象 adj. 服从的, 易患的 vt. 使隶属, 使服从; 使遭遇"] },
  {
    "name": "job",
    "trans": ["n. 工作,职责,任务 vt. 投机买卖,营私舞弊,不公正地判罚,分包任务 vi. 工作,假公济私,做分销商或批发商 adj. 与工作有关的"]
  },
  { "name": "differentiate", "trans": ["vt. 识别, 使差异, 求导数, 区分, 区别对待 vi. 区别,变异"] },
  { "name": "distinction", "trans": ["n. 区别; 卓越; 殊荣"] },
  { "name": "distinguish", "trans": ["vt. 区别,辨认,特别关注 vi. 区别"] },
  { "name": "locking", "trans": ["n. 锁定 动词lock的现在分词形式"] },
  { "name": "progress", "trans": ["n. 进步, 发展, 前进 vi. 促进，进步, 进行"] },
  { "name": "fundamental", "trans": ["adj. 基本的,根本的,重要的 n. 基本原理,基础"] },
  ...
  { "name": "vital", "trans": ["adj. 至关重要的, 生死攸关的, 有活力的, 充满生机的"] },
  ...
  { "name": "inclusive", "trans": ["adj. 包含...在内的, 包罗广泛的, 包括端点的 [计算机] 包括的"] },
  { "name": "charm", "trans": ["n. 魔力, 魅力, 护身符, 小饰物 vt. 吸引, 使...迷醉, 对...施以魔法"] },
  { "name": "hit", "trans": ["n. 打(击),冲撞,讽刺,成功.一次毒品的剂量,点击量 vt. 打(击),碰撞,偶然发现,要求,符合 vi. 打(击),袭击,达到"] },
  ...
  { "name": "accidental", "trans": ["adj. 意外的,偶然的,附属的 n. 偶然,不重要的东西,变调的临时符号"] },
  { "name": "sequential", "trans": ["adj. 连续的(序贯的)"] },
  { "name": "indirect", "trans": ["adj. 间接的, 迂回的，次要的，不坦率的，欺骗的"] },
  { "name": "reappear", "trans": ["vi. 再出现"] },
  { "name": "circumstance", "trans": ["n. 环境,(复数)境况,事件,详情"] },
  { "name": "mix", "trans": ["n. 混合(物),融合 vt. &vi. 混合,掺入,合成,交往,联系 [计算机] 混合"] },
  { "name": "suppress", "trans": ["vt. 镇压,使...止住,禁止"] },
  { "name": "E", "trans": ["n.字母E"] },
  { "name": "recognition", "trans": ["n. 认出,承认, 感知，知识"] },
  { "name": "arm", "trans": ["n. 手臂, 港湾, 狭长地带, 扶手, 袖子, 枪 vt. 装备, 准备(炸弹) vi. 武装自己"] },
  ...
  { "name": "batch", "trans": ["n. 一次所烘的面包,一次所制之量,一组, 批, 分批 vi. 分批处理"] },
  { "name": "brush", "trans": ["n. 刷子,画笔,轻擦,小冲突, 灌木丛 vt. 用刷子清洗,画,拭去,打发 vi. 轻擦,拂拭"] },
  { "name": "calculator", "trans": ["n. 计算器"] },
  { "name": "punch", "trans": ["n. 打洞器,钻孔机,殴打 n. 酒、水、糖等制成的鸡尾酒 vt. 以拳重击,开洞,剪票,按(键)"] },
  { "name": "reader", "trans": ["n. 读者，读物, 读本"] },
  { "name": "cell", "trans": ["n. 细胞, 电池, 小组, 小房间, 单人牢房, (蜂房的)巢室, 手机"] },
  { "name": "channel", "trans": ["n. 通道,频道,海峡,方法 vt. 引导,开导,形成河道,输送"] },
  { "name": "circuit", "trans": ["n. 电路,一圈,巡回 vt. &vi. 巡回"] },
  { "name": "to", "trans": ["prep. (表示方向)到,向；(表示间接关系)给；离,对于,为了 adv. （表示方向）去,（门）关上"] },
  { "name": "coder", "trans": ["n. 编码器"] },
  { "name": "unit", "trans": ["n. 单位, 单元"] },
  { "name": "core", "trans": ["n.中心，核心，精髓； 果心，果核； [地质学]地核； [计] 磁心 vt.去（果）核，挖去…的果心； 提取岩芯（样品）"] },
  { "name": "cybernetics", "trans": ["n. 控制论"] },
  { "name": "disc", "trans": ["n. 圆盘，[电子] 唱片（等于disk） vt. 灌唱片"] },
  { "name": "drum", "trans": ["n. 鼓, 鼓声, 鼓状物, 冰丘 vi. 击鼓, 作鼓声, 引起兴趣 vt. 召集入伍, 逐出, (经过努力)推动..., 连续击打"] },
  { "name": "electronics", "trans": ["n. 电子学，电子器件"] },
  { "name": "emitter", "trans": ["n.发射器"] },
  { "name": "encode", "trans": ["vt. 编码, 译码"] },
  { "name": "feedback", "trans": ["n. 反馈,成果"] },
  { "name": "flow", "trans": ["vi.流； 垂； 流出； （谈话、文体等）流畅 n.流动； 滔滔不绝； 涨潮； 连贯 vt.使泛滥； 淹没； 排出"] },
  { "name": "frame", "trans": ["n. 框,结构,骨架 v. 构成，把...框起来，陷害 adj. 木结构的"] },
  { "name": "identifier", "trans": ["n. 标识符"] },
  { "name": "inquiry", "trans": ["n. 打听, 询问, 调查, 查问 =enquiry(英)"] },
  { "name": "integrated", "trans": ["adj. 整合的,综合的 vt.&vi. 使整合(integrate的过去式及过去分词)"] },
  ...
  { "name": "panel", "trans": ["n.镶板； 面； （门、墙等上面的）嵌板； 控制板 vt.选定（陪审团）； 把…分格； 在…上置鞍垫； 把…镶入框架内"] },
  ...
  { "name": "pentium", "trans": ["Intel公司生产的CPU芯片,中文译名为\"奔腾\""] },
  { "name": "kilo", "trans": ["pref. 表示“千” abbr. 千克，公斤(=kilogram/kilogramme)"] },
